#include "FileWithIncomies.h"//to moze poczekac, teraz zajmiemy sie datami

/*void FileWithIncomies::addIncomiesToFileXML(User user){
    CMarkup xml;
...
vector <Incomies> FileWithIncomies::loadIncomiessFromFileXML(){
    Incomies incomiesV;
    vector <User> users;
    CMarkup xml1;
